<nav class="navbar navbar-default navbar-fixed-top sticky">
    <div class="container-fluid" id="navbarGames">
        <div class="navbar-header">
            ...
            @php
                $currency = \App\Models\Currency::where('code', request()->route('currency'))->first();
            @endphp
            ...
            <div class="navbar-text pull-left">
                <div>
                    <span id="lblUsdBalance" data-toggle="tooltip" class="tooltipLink"
                        ...
                        <span id="lblCoinName" style="color: white; text-transform: uppercase">{{ $currency ? $currency->code : '' }}</span>
                    </span>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            @php
                $currencies = \App\Models\Currency::where('is_active', true)->orderBy('position')->get();
            @endphp
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                        <li>
                            <a class="a_swindow" href="{{ route('deposit', ['currency' => request()->route('currency')]) }}">
                                <i class="fa fa-bank fa-fw fa-lg fa-fw" aria-hidden="true"></i>Депозит</a>
                        </li>
                        <li>
                            <a class="a_fwindow" href="https://crypto.games/account/exchange">
                                <i class="fa fa-exchange fa-fw fa-lg fa-fw" aria-hidden="true"></i>Обмен</a>
                        </li>
                        <li><a class="a_fwindow" href="{{ route('withdraw', ['currency' => request()->route('currency')]) }}">
                                <i class="fa fa-suitcase fa-fw fa-lg fa-fw" aria-hidden="true"></i>Вывод</a>
                        </li>
                        <li class="divider"></li>
                        <li>
...
<div class="sidebar">
    <div class="sidebar-wrapper">
        <div class="sidebar-item">
            <a href="{{ route('dice', ['currency' => $currency->code]) }}" class="sidebar-link @if(request()->route()->getName() === 'dice') sidebar-link_active @endif">
{{--                <span class="sidebar-link__new-label" style="display:none;">New</span>--}}
        ...
        <div class="sidebar-item">
            <a href="{{ route('mines', ['currency' => $currency->code]) }}" class="sidebar-link @if(request()->route()->getName() === 'mines') sidebar-link_active @endif">
        ...
        <div class="sidebar-item">
            <a href="{{ route('keno', ['currency' => $currency->code]) }}" class="sidebar-link @if(request()->route()->getName() === 'keno') sidebar-link_active @endif">
        ...
        <div class="sidebar-item">
            <a href="{{ route('dice_v2', ['currency' => $currency->code]) }}" class="sidebar-link @if(request()->route()->getName() === 'dice_v2') sidebar-link_active @endif">
